...
<body>
    <?php
    echo $header;
    $query = "SELECT * FROM articles inner join categories on articles.categorie = categories.id WHERE categories.libelle = 'Education' ORDER BY dateModification DESC";
